...
const DonationPage = () => {
  ...
  return (
    <div className="h-[90%] w-full object-contain dark:bg-gray-800 dark:text-white"
      style={{
        backgroundImage: 'url("footprints.webp")',
        backgroundPosition: 'top'
      }}>
      <div className="max-w-3xl mx-auto p-6 bg-orange-300 dark:bg-orange-700 rounded-lg shadow-lg my-5">
        <h1 className="text-4xl font-bold text-center text-gray-800 dark:text-gray-200 mb-6">Support Our Animal Shelter</h1>
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          <div className="space-y-2">
            <label htmlFor="donorName" className="text-lg text-gray-700 dark:text-gray-300">Your Name</label>
            <input
              type="text"
              id="donorName"
              value={donorName}
              ...
              placeholder="Enter your name"
              required
              className="w-full p-3 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
            />
          </div>

          <div className="space-y-2">
            <label htmlFor="donorEmail" className="text-lg text-gray-700 dark:text-gray-300">Your Email</label>
            <input
              type="email"
              id="donorEmail"
              value={donorEmail}
          ...
          <div className="space-y-2">
            <label htmlFor="donationAmount" className="text-lg text-gray-700 dark:text-gray-300">Donation Amount</label>
            <input
              type="number"
              id="donationAmount"
              value={donationAmount}
          ...
          <div className="space-y-2">
            <label htmlFor="donationMessage" className="text-lg text-gray-700 dark:text-gray-300">Message (Optional)</label>
            <textarea
              id="donationMessage"
              value={donationMessage}
              onChange={(e) => setDonationMessage(e.target.value)}
