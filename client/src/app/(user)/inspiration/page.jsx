  ...
  return (
    <div className="flex justify-center items-center h-screen bg-gray-900 dark:bg-gray-800">
      <div className="flex h-full items-center justify-center bg-blue-100 dark:bg-blue-900">
        <div className="grid md:grid-cols-2 grid-cols-1 items-center gap-10 md:px-10 px-4 py-10">
          <div className="text-center md:text-left">
            <h1 className="mb-2 text-3xl font-bold text-gray-600 dark:text-white">
              <span className="text-green-600">Hi,</span> I'm OSSUM the Bunny!
            </h1>
            ...
            <div className="flex justify-center md:justify-start space-x-5 mt-4">
              <button className="flex w-full items-center justify-center gap-1 rounded-2xl bg-yellow-300 p-5 py-3 font-semibold text-white hover:text-yellow-300 hover:bg-white dark:bg-yellow-500 dark:hover:bg-yellow-400 dark:text-gray-900">
                Follow
              </button>
              <button className="flex w-full items-center justify-center gap-2 rounded-2xl bg-white p-5 py-3 font-semibold text-gray-900 hover:bg-gray-200 dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600">
                Contribute your own BLOG!
              </button>
            </div>
          </div>
