    ...
    <div className='flex flex-col justify-center items-center h-full w-full bg-white'>
      ...
      <div className='z-10 h-auto w-full'>
        <div className='w-full h-full text-center pt-10'
          ...
          <h1 className='text-4xl md:text-6xl lg:text-7xl text-green-500 font-bold'>#EmpathyInAction</h1>
          <p className='text-xl md:text-2xl lg:text-3xl text-white mt-2'>Compassionate care for the forgotten and neglected</p>

          <div className='mt-5 flex flex-col lg:flex-row justify-between pb-4'>

            <ul className='flex justify-center lg:justify-end gap-5 md:gap-8 lg:gap-10 px-5 md:px-8 lg:px-10 text-slate-400'>
              <li>
                <a className='hover:text-blue-300' target='_blank' href="#">
                  Virtual First-Aid
                </a>
              </li>
              <li>
            ...
            <ul className='flex justify-center lg:justify-start gap-5 md:gap-8 lg:gap-10 px-5 md:px-8 lg:px-10 text-slate-400 mt-5 lg:mt-0'>
              <li>
      ...
      <div className='flex w-full h-[80vh] bg-gradient-to-b from-green3 to-green2 justify-center items-center'>
        ...
        <div className='rounded-full w-1/3 h-4/5 m-10 flex justify-center items-center overflow-hidden bg-contain bg-no-repeat bg-yellow-300'
          style={{
        ...
        <div className='w-2/3 p-20'>
          <h1 className='font-bold text-3xl text-yellow-300 my-5'>Adopt Action: A Second Chance at Life</h1>
      ...
      <div className='flex w-full h-[80vh] bg-gradient-to-b from-green2 to-green4 justify-center items-center'>

        <div className='w-2/3 p-20'>
          <h1 className='font-bold text-3xl text-green-300 my-5'>Feed a Friend: Make a Difference</h1>
          <p className='text-2xl text-white'>
        ...
        <div className='rounded-full w-1/3 h-4/5 m-10 flex justify-center items-center overflow-hidden bg-contain bg-no-repeat'
          style={{
      ...
      {/* volunteer section */}
      <div className='w-full h-[80vh] bg-gradient-to-b from-green4 to-green3 flex justify-center items-center'>

        <div className='rounded-full w-1/3 h-4/5 m-10 flex justify-center items-center overflow-hidden bg-contain bg-no-repeat bg-blue-30'
          style={{
        ...
        <div className='w-2/3 p-20'>
          <h1 className='font-bold text-3xl text-orange-400 my-5'>Volunteer with Us: Be a Hero for Animals</h1>
          <p className='text-2xl text-white'>
