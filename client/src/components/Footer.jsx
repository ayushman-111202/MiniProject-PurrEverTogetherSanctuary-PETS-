...
//                                 Drop your email to get notified whenever a new soul enters our Sanctuary❤️
//                             </strong>
//                             <form className="mt-6">
...
//                                         href="https://www.facebook.com/ayushman.shukla.35977897"
//                                         target="_blank"
//                                         rel="noreferrer"
//                                     >
...
//                                     <a
//                                         className="text-gray-700 transition hover:text-gray-700/75"
//                                         href="https://x.com/Ayushman_1311"
//                                         target="_blank"
//                                         rel="noreferrer"
//                                     >
...
//                                     <a
//                                         className="text-gray-700 transition hover:text-gray-700/75"
//                                         href="https://www.github.com/ayushman-111202"
//                                         target="_blank"
//                                         rel="noreferrer"
//                                     >
...
const Footer = () => {
    return (
        <div>
            <footer className="bg-gradient-to-b from-orange-300 dark:bg-gradient-to-b dark:from-gray-900 dark:to-gray-800">
                <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8">
                    <div className="mx-auto max-w-md">
                        ...
                        <form className="mt-6">
                            <div className="relative max-w-lg">
                                ...
                                <input
                                    className="w-full rounded-full border-gray-200 bg-gray-100 dark:bg-gray-700 dark:border-gray-600 p-4 pe-32 text-sm font-medium text-gray-900 dark:text-gray-300"
                                    id="email"
                                    type="email"
                                    placeholder="john@doe.com"
                                />
                    ...
                    <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
                        <div className="mx-auto max-w-sm lg:max-w-none">
                            <p className="mt-4 text-center text-gray-700 lg:text-left lg:text-lg dark:text-gray-400">
                                Follow our social handles to keep yourself updated about adaptions, donations, events, incoming members, collaborations and many more...
                            </p>
                            <div className="mt-6 flex justify-center gap-4 lg:justify-start">
                                <a
                        ...
                        <div className="grid grid-cols-1 gap-8 text-center lg:grid-cols-3 lg:text-left">
                            <div>
                                <strong className="font-medium text-gray-900 dark:text-gray-100"> PETS </strong>
                                <ul className="mt-6 space-y-1">
                                    <li>
                                        <a
                    ...
                    <div className="mt-16 border-t border-gray-200 pt-8 dark:border-gray-700">
                        <p className="text-center text-xs/relaxed text-gray-500 dark:text-gray-400">
                            ...
                            <a
                                ...
                                className="text-gray-700 underline transition hover:text-gray-700/75 dark:text-gray-400"
                            >
                                Ayushman Shukla
                            </a>
                            &nbsp; and inspired by
