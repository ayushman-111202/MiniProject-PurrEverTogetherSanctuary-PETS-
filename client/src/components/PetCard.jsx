            ...
            <div className='grid grid-cols-3 gap-4 p-4'>
                {
                    ...
                    petList.map((pets) => {
                        ...
                        return <div className="bg-orange-300 m-2 shadow-[0_4px_12px_-5px_rgba(0,0,0,0.4)] w-full  rounded-xl text-gray-600 overflow-hidden mx-auto font-[sans-serif]" key={pets._id}>
                            <div className="flex items-center justify-center max-h-[480px] bg-slate-300 h-3/5 w-full overflow-clip">
                                <img src={pets.image} className='w-full h-full object-cover' />
                            </div>
